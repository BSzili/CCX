...
//UNUSED	MRect           backdropPortZRect = { 0, 0, 480, 640 };
	SDL_Rect        backdropSDLRect = { 0, 0, 640, 480 };
	SDL_Rect        cursorBackSDLRect = { 0, 0, kCursorWidth, kCursorHeight };
//UNUSED	SDL_Rect        cursorFrontSDLRect = { 0, 0, kCursorWidth, kCursorHeight };
...
{
	{ "Programming", "John Stiles", "Philip Stopford", "", "", "" },
